...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('Instagrama\Comment')->orderBy('id', 'desc');
    }

    // Relación One To Many / de uno a muchos /un usuario sube  muchas fotografías
    public function image()
    {
        return $this->hasMany('Instagrama\Image')->orderBy('id', 'desc');
    }

    // Relación One To Many / de uno a muchos /un usuario da muchos likes
    public function likes()
    {
        return $this->hasMany('Instagrama\Like')->orderBy('id', 'desc');
    }
}